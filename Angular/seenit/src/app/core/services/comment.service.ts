...
import { CommentInfoModel } from 'src/app/components/shared/models/comment-info.model';
...
export class CommentService {
  ...
  getAllForPost(postId: string) {
    return this.http.get<CommentInfoModel[]>(`${this.CREATE_COMMENT}?query={"postId":"${postId}"}&sort={"_kmd.ect": -1}`, {
